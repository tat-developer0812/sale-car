...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['sedan', 'suv', 'mpv', 'hatchback', 'pickup']
    >;
    ...
    leadCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    specs: Schema.Attribute.Component<'car.specs', false>;
    status: Schema.Attribute.Enumeration<['available', 'sold', 'coming-soon']> &
      Schema.Attribute.DefaultTo<'available'>;
    stockCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiLeadLead extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer lead/inquiry';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    ...
    interestedCar: Schema.Attribute.Relation<'manyToOne', 'api::car.car'>;
    ...
    source: Schema.Attribute.Enumeration<
      ['contact-form', 'test-drive', 'quote-request', 'call-button']
    >;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['review', 'comparison', 'guide', 'news', 'promotion']
    >;
